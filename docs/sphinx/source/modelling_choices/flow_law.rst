...
An alternative flow-law regularization that affects only non-SIA dynamics can be done via defining a minimum value for the effective strain rate (parameter ``D_E_MIN``).
