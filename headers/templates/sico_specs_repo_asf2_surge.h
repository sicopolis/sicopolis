...
#define GRID 0
!                       0 : Cartesian coordinates in the
!                           stereographic plane
!                       1 : Stereographically expanded Cartesian
!                           coordinates on the surface of the earth
!                       2 : Latitude/longitude grid on the surface
!                           of the earth (not allowed for this application)
...
#define STEREO_PROJ_LATD0 79.7208d0
!                       Standard parallel (in degN)
!                       (only for GRID==0, 1)

#define STEREO_PROJ_LOND0 15.0d0 /* central meridian of UTM33 */
...
!                       or GRID==1
!                       (4 km requires IMAX= 34 and JMAX= 33,
!                        2 km requires IMAX= 68 and JMAX= 66,
!                        1 km requires IMAX=136 and JMAX=132)
...
!                         for flow-law regularization
!                         (alternative to FIN_VISC=2/SIGMA_RES,
!                          affects only non-SIA dynamics).
...
#define ZS_PRESENT_FILE 'asf_gridfit_smooth5_2k_zs.dat'
...
#define ZL_PRESENT_FILE 'asf_gridfit_smooth5_2k_zl.dat'
!                         Name of the file containing the present-day
!                         lithosphere-surface topography
!                         (only for ANF_DAT==1)

#define ZL0_FILE 'asf_gridfit_smooth5_2k_zl0_elra.dat'
...
!                         1 : Ocean connectivity enforced by 8-connectivity
!                             (via cell edges and corners).
!                         2 : Ocean connectivity enforced by 4-connectivity
!                             (via cell edges only).
...
#define TEMP_PRESENT_PARA 0
!                       Parameterization of the present-day mean-annual
!                       and mean-July (mid-summer) surface temperatures:
...
#define THETA_MA_0 -30.0d0    /* in degC      */
#define GAMMA_MA_0   6.5d0    /* in K/km      */
#define C_MA_0       0.0d0    /* in K/deg_lat */
#define KAPPA_MA_0   0.0d0    /* in K/deg_lon */

#define THETA_MJ_0 -10.0d0    /* in degC      */
#define GAMMA_MJ_0   6.5d0    /* in K/km      */
#define C_MJ_0       0.0d0    /* in K/deg_lat */
...
!                       states (only for TSURFACE==1 or TSURFACE==6)
...
#define WRITE_SER_FILE_STAKES 0
!                         0 : No writing of extended time-series files '.dat'
!                             for the surface climate at mass balance stakes
!                         1 : Writing of extended time-series files '.dat'
!                             for the surface climate at mass balance stakes
