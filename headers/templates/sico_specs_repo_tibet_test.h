...
#define PHI_0    25.0d0
!                       y coordinate (latitude, in deg) of the origin point
!                       (i,j) = (0,0), for GRID==2

#define DLAMBDA  (1.0d0/3.0d0)
!                       Horizontal grid spacing (longitude) in deg,
!                       for GRID==2

#define DPHI     (1.0d0/3.0d0)
!                       Horizontal grid spacing (latitude) in deg,
!                       for GRID==2
!                       (dlambda = dphi = 20 min = 1/3 deg
!                                   requires IMAX=135 and JMAX= 51,
!                        dlambda = dphi = 10 min = 1/6 deg
!                                   requires IMAX=270 and JMAX=102,
!                        dlambda = dphi = 5 min = 1/12 deg
!                                   requires IMAX=540 and JMAX=204)
...
#define ZS_PRESENT_FILE 'tibet_e2_20_zs_sm100.dat'
...
#define ZL0_FILE 'tibet_e2_20_zl0_sm100_elra.dat'
...
#define MASK_PRESENT_FILE 'tibet_e2_20_mask.dat'
!                         Name of the file containing the present-day
!                         ice-land-ocean mask
