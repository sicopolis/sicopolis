...
!
!! NPI domain: Declarations of global variables for SICOPOLIS.
!!
!!##### Authors
!!
!! Ralf Greve
...
real(dp), dimension(0:NZ_TF_BM) :: z_tf_bm_present
   !! Equidistant depth points of the present-day thermal forcing data
   !! of the ocean
...
real(dp), dimension(0:NZ_TF_BM) :: z_tf_bm
   !! Equidistant depth points of the thermal forcing data of the ocean
